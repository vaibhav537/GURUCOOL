...
const DeleteCategory = () => {
  ...
  return (
    <>
      <Head>
        <title>GURUCOOL : Delete Category</title>
        <meta
          name="description"
            ...
            <form className="flex flex-col " data-aos="fade-up">
              ...
              <div className="pt-20">
                <button
                  ...
                  className={` ${
                    disableButton
                      ? "select-none cursor-not-allowed font-bold font-Crimson text-lg text-white bg-teal-400 uppercase rounded  hover:bg-teal-300  hover:text-teal-500 transition-all duration-700 dark:text-white bg-transparent p-2 px-5 dark:bg-teal-700 dark:hover:bg-teal-900"
                      : "select-none font-bold font-Crimson text-lg text-white bg-teal-500 uppercase rounded  hover:bg-teal-300  hover:text-teal-500 transition-all duration-700 dark:text-white bg-transparent p-2 px-5 dark:bg-teal-700 dark:hover:bg-teal-900 cursor-pointer hover:shadow-3xl"
                  }`}
                >
                  {loading ? (
