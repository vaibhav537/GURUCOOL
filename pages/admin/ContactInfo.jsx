...
const ContactInfo = () => {
  ...
  return (
    <>
      <Head>
        <title>MEET-IN : Contact Info.</title>
        <meta
          name="description"
      ...
      <div className="bg-purple-300 dark:bg-slate-600 w-[100vw] h-[100vh] transition-all duration-1000">
        ...
        <div className="flex">
          ...
          <div className="pl-[20rem] pt-[3rem]">
            <p className=" text-center text-4xl font-bold select-none text-gray-100">
              CONTACT INFORMATION OF THE{" "}
              <span className="text-white">GURUCOOL</span>
            </p>
            ...
            <span className="fixed top-[55rem] right-[47rem]  text-xl">
