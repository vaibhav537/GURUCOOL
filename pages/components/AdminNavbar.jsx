    ...
    <div>
      <div>
        <Image
          ...
          width={150}
          height={150}
          className="pl-10 ml-[7px] w-[166px] mb-5  transition-all duration-1000 dark:invert-[1]"
        />
        ...
        <a
            className={`flex uppercase items-center  border-2 justify-center p-2 font-Crimson font-semibold mb-[3rem] text-[23px] 
        ...
        <Link legacyBehavior href={"/admin/Addcategory"}>
          <a
            className={`flex items-center border-2 uppercase  justify-center p-2 font-Crimson font-semibold mb-[3rem] text-[23px]
        ...
        <a
            className={`flex items-center border-2   justify-center p-2 font-Crimson font-semibold mb-[3rem] text-[23px] 
