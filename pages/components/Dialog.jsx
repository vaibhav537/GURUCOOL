          ...
          <div className="bg-white p-5 rounded flex flex-col ">
            ...
            <form className="flex justify-center items-center flex-col my-5">
              ...
              <div className="mt-8">
                <button
                  type="submit"
                  className="bg-teal-600 p-2 text-white font-bold rounded hover:shadow-3xl hover:bg-teal-800 hover:text-teal-300 transition-all duration-500 cursor-pointer select-none"
                  onClick={handleOTP}
                >{isLoading? <img src="/adminIdPass.gif" alt="..." className=""/> :'Confirm'}</button>
              </div>
              <span className="mt-5 text-teal-800 font-semibold hover:text-teal-400 cursor-pointer transition-all duration-500 select-none" onClick={handleResend}>
            ...
            }
            {
              ...
              <h1 className="select-none text-3xl my-5">Change ID Password</h1>
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-center mt-5">
                  <button type="submit" onClick={handleAdminChange} className="bg-teal-600 p-2 text-white font-bold rounded hover:shadow-3xl hover:bg-teal-800 hover:text-teal-300 transition-all duration-500 cursor-pointer select-none">{isLaoding ? <img src="/adminIdPass.gif" alt="..." className=""/> :"Change"}</button>
                </div>
              </form>
              </div>
              </>
